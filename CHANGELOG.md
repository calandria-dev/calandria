...
* **advanced-env:** add mandatory approval and turn capability primitives ([#410](https://github.com/calandria-dev/calandria/issues/410)) ([be3bab5](https://github.com/calandria-dev/calandria/commit/be3bab55ec9026bd281175394bc70dad918cc936))
* **advanced-env:** add proposal service and private approval inputs ([#411](https://github.com/calandria-dev/calandria/issues/411)) ([cc6290e](https://github.com/calandria-dev/calandria/commit/cc6290e9dce223f2a1ae056947f8fe42d465440b))
...
* **advanced-env:** add Settings -&gt; Advanced app and agent environment tables ([#409](https://github.com/calandria-dev/calandria/issues/409)) ([a4c3aa2](https://github.com/calandria-dev/calandria/commit/a4c3aa2fc6e3dbd09aa2405585aced297fc14afb))
...
* **advanced-env:** wire agent tools and safe transport lifecycle ([#412](https://github.com/calandria-dev/calandria/issues/412)) ([b45f509](https://github.com/calandria-dev/calandria/commit/b45f5096cba9ec044461977a54f00abe67b71b57))
...
* **agent-tools:** refuse done while a worktree holds stranded work ([#418](https://github.com/calandria-dev/calandria/issues/418)) ([a8fb106](https://github.com/calandria-dev/calandria/commit/a8fb1065c6c605a37bd4f799c15560e28218094d))
...
* **tasks:** fold any status group in the list, not only Done ([#417](https://github.com/calandria-dev/calandria/issues/417)) ([ce6808c](https://github.com/calandria-dev/calandria/commit/ce6808cff346a4c035800e9e467cd1793787f59c))


### Bug Fixes

* **advanced-env:** guard the one-shot secret approval and settle crashed proposals ([#414](https://github.com/calandria-dev/calandria/issues/414)) ([0ffc049](https://github.com/calandria-dev/calandria/commit/0ffc04978d16c95626a0574386563783f773ecd7))
...
* **codex:** re-probe the sandbox before refusing a turn ([#415](https://github.com/calandria-dev/calandria/issues/415)) ([b18e6b5](https://github.com/calandria-dev/calandria/commit/b18e6b54ff3096cc1f081313340f44539777631f))
...
* **issues:** draft a GitHub bug report or feature request inline ([#388](https://github.com/calandria-dev/calandria/issues/388)) ([1eed6e8](https://github.com/calandria-dev/calandria/commit/1eed6e834615aac4f875b435621ce41973d2fd99))
