 ...
 *   - CALANDRIA_ALLOWED_ORIGINS adds comma-separated, exact http(s) origins for
 ...
 * CALANDRIA_PTY_ALLOW_REMOTE=1. Anything that reaches the sidecar gets a shell,
 * so that opt-in means "I have my own network controls".
 *
