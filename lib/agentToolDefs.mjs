...
export const UPDATE_TASK = {
  name: "update_task",
  description:
    "Update a task — retitle it, rewrite its description, change its priority, or set its status (e.g. mark it done once the work is " +
    "finished). Pass only the fields you want to change; anything omitted is left exactly as it is. " +
  ...
  params: {
    ...
    status:
      ...
      "and on your own task it would abort this very turn.",
  },
  priorities: ["hi", "med", "lo"],
