...
const defaultDbDir = () => path.join(homeDir(), ".calandria");
const legacyDbDir = () => path.join(homeDir(), ".zen-orchestrator");
const defaultWorktreesDir = () => path.join(homeDir(), ".calandria", "worktrees");
const legacyWorktreesDir = () => path.join(homeDir(), ".agent-orchestrator", "worktrees");
