...
you can edit and comment in a single pass.
...
| Text edits | Not saved. Closing the window discards them, after a confirmation. |
| General comments box | Not saved, and discarded with the edits. |
