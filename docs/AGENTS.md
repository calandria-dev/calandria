...
Calandria composes those headers per turn. `ANTHROPIC_CUSTOM_HEADERS` is never taken from
stored configuration. The key is absent from provider and project rows. It lives in a 0600 file
