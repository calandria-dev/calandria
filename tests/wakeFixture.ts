 ...
 * local midnight got `"Sat 00:03"` and failed. Formatting itself is pinned on
 * a frozen clock in `tests/sessionCrons.test.ts`; these suites only care that
 * the notice names THIS wakeup.
 */
