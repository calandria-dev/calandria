...
// route is deliberately project-agnostic and names the project it landed in.
//
// It exists rather than reusing GET /api/tasks/[id] for two reasons. That route
...
// a transcript re-read after one has to render the card as gone rather than as
