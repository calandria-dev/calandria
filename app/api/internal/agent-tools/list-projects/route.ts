...
//
// This is a POST because the bridge speaks one shape to every agent-tool
// endpoint. `projectId` is the session's own project, used solely to flag
// which row is "current". An unknown one isn't an error: the list is still
// useful, nothing is just marked current.
