...
//
// The agent id comes off the CALLER'S ROW, not the body: a model must not file
...
export async function POST(req: NextRequest) {
  ...
  logAgentToolArrival("create_runbook", "bridge", body.taskId);
  ...
  // request either omitted a required field or named a project this tool can't
  // resolve. `error` is what the bridge shows the agent, and what tells it how
  // to retry.
