    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
      ...
      {endpoint?.base_url && (
        <div className="field" style={{ marginBottom: 0 }}>
          ...
          <div className="hlp">
            {endpointSummary(endpoint)}. This seeds a Local model provider a task can pick in the model picker;
            {" "}the address is <code className="ctx-mono">CALANDRIA_LOCAL_MODEL_BASE_URL</code>.
          </div>
        </div>
      )}
