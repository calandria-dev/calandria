  ...
  return (
    <aside className="sess-rail">
      ...
      <div className="rail-scroll">
        {tab === "diff" && (
          <TaskChanges taskId={task.id} projectId={project.id} running={running} pr={task} onMerged={onMerged} onPrCreated={onPrCreated} onSyncChanged={onSyncChanged} refresh={refreshChanges} onSend={onSend} onResolveWithAI={async (id) => {
