...
// answer. Each agent's descriptor spells its own modes (Codex's "auto" is
// its reviewer-decided mode, not an inherit), so filtering from the real
// per-agent list instead of a fixed three-item list is what keeps a
// schedule from offering a mode the agent doesn't have.
